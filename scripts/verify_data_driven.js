...
async function verifyTimetableLogic() {
    console.log('--- Verifying Data-Driven Timetable Logic ---');
    ...
    try {
        ...
        console.log(`Using Year: ${yearId}, Teacher1: ${teacher1.id}, Teacher2: ${t2Id}`);
        ...
        `;
        console.log(`Created ClassSection: ${classSection.id}, Initial Teacher: ${classSection.class_teacher_id}`);
        ...
        `;
        console.log('Conflicting Slots for Teacher 1:', conflicts);
        ...
        `;
        console.log('Cleaned up conflicts for Monday Period 1');


        // 2. Test Trigger: Insert Monday Period 1
        console.log('Inserting Monday Period 1 Slot...');
        ...
        console.log(`After Insert, Class Teacher: ${updatedCS1.class_teacher_id}`);

        if (updatedCS1.class_teacher_id !== teacher1.id) {
            console.error('FAIL: Class Teacher did not update to Teacher 1');
        } else {
            console.log('PASS: Class Teacher updated to Teacher 1');
        }

        // 3. Test Trigger: Update Teacher
        console.log('Updating Slot to Teacher 2...');
        await sql`
        ...
        console.log(`After Update, Class Teacher: ${updatedCS2.class_teacher_id}`);

        if (updatedCS2.class_teacher_id !== t2Id) {
            console.error('FAIL: Class Teacher did not update to Teacher 2');
        } else {
            console.log('PASS: Class Teacher updated to Teacher 2');
        }
        ...
        console.log(`After Delete, Class Teacher: ${updatedCS3.class_teacher_id}`);

        if (updatedCS3.class_teacher_id !== null) {
            console.error('FAIL: Class Teacher did not reset to NULL');
        } else {
            console.log('PASS: Class Teacher reset to NULL');
        }
